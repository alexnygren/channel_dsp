...
#define AUDIO_BUFFER_FRAMES 4 // orig 48
#define STEREO_BUFFER_SIZE  AUDIO_BUFFER_FRAMES * 2  // roughly 2ms, 48 L + R words
...
typedef struct pio_i2s {
    PIO        pio;
    PIO        spio;  // sends pio - secondary pio
    uint8_t    sm_mask;
    uint8_t    sm_mask1;
    uint8_t    sm_sck;
    uint8_t    sm_dout;
